//===--- INODE.cpp - Implement RISC-V target feature support --------------===//
//
...
// #include "llvm/TargetParser/INODETargetParser.h"
#include <optional>

using namespace clang;
using namespace clang::targets;

ArrayRef<const char *> INODETargetInfo::getGCCRegNames() const {
  // clang-format off
...
ArrayRef<TargetInfo::GCCRegAlias> INODETargetInfo::getGCCRegAliases() const {
...
bool INODETargetInfo::validateAsmConstraint(
...
// std::string INODETargetInfo::convertConstraint(const char *&Constraint) const {
//   std::string R;
//   switch (*Constraint) {
//   case 'v':
...
void INODETargetInfo::getTargetDefines(const LangOptions &Opts,
                                       MacroBuilder &Builder) const {
  // Builder.defineMacro("__riscv");
  // bool Is64Bit = getTriple().isINODE64();
  ...
  //                       Twine(VScale->first * llvm::INODE::RVVBitsPerBlock));
...
// #include "clang/Basic/BuiltinsINODEVector.def"
#define BUILTIN(ID, TYPE, ATTRS)                                               \
  {#ID, TYPE, ATTRS, nullptr, HeaderDesc::NO_HEADER, ALL_LANGUAGES},
#define TARGET_BUILTIN(ID, TYPE, ATTRS, FEATURE)                               \
  {#ID, TYPE, ATTRS, FEATURE, HeaderDesc::NO_HEADER, ALL_LANGUAGES},
#include "clang/Basic/BuiltinsINODE.def"
};

ArrayRef<Builtin::Info> INODETargetInfo::getTargetBuiltins() const {
  return llvm::ArrayRef(BuiltinInfo,
                        clang::INODE::LastTSBuiltin - Builtin::FirstTSBuiltin);
}

// bool INODETargetInfo::initFeatureMap(
//     llvm::StringMap<bool> &Features, DiagnosticsEngine &Diags, StringRef CPU,
//     const std::vector<std::string> &FeaturesVec) const {

//   unsigned XLen = 32;

//   if (getTriple().isINODE64()) {
//     Features["64bit"] = true;
//     XLen = 64;
//   } else {
//     Features["32bit"] = true;
...
//   const auto I = llvm::find(FeaturesVec, "__INODE_TargetAttrNeedOverride");
...
//       return !llvm::INODEISAInfo::isSupportedExtensionFeature(Ext);
//     };
...
//   auto ParseResult = llvm::INODEISAInfo::parseFeatures(XLen, FeaturesVec);
//   if (!ParseResult) {
//     std::string Buffer;
...
// INODETargetInfo::getVScaleRange(const LangOptions &LangOpts) const {
//   // INODE::RVVBitsPerBlock is 64.
//   unsigned VScaleMin = ISAInfo->getMinVLen() / llvm::INODE::RVVBitsPerBlock;
...
//   if (VScaleMin > 0) {
//     unsigned VScaleMax = ISAInfo->getMaxVLen() / llvm::INODE::RVVBitsPerBlock;
...
// bool INODETargetInfo::hasFeature(StringRef Feature) const {
//   bool Is64Bit = getTriple().isINODE64();
...
// bool INODETargetInfo::handleTargetFeatures(std::vector<std::string> &Features,
//                                            DiagnosticsEngine &Diags) {
//   unsigned XLen = getTriple().isArch64Bit() ? 64 : 32;
//   auto ParseResult = llvm::INODEISAInfo::parseFeatures(XLen, Features);
//   if (!ParseResult) {
//     std::string Buffer;
//     llvm::raw_string_ostream OutputErrMsg(Buffer);
//     handleAllErrors(ParseResult.takeError(), [&](llvm::StringError &ErrMsg) {
...
// bool INODETargetInfo::isValidCPUName(StringRef Name) const {
//   bool Is64Bit = getTriple().isArch64Bit();
//   return llvm::INODE::parseCPU(Name, Is64Bit);
// }

// void INODETargetInfo::fillValidCPUList(
//     SmallVectorImpl<StringRef> &Values) const {
//   bool Is64Bit = getTriple().isArch64Bit();
//   llvm::INODE::fillValidCPUArchList(Values, Is64Bit);
// }

// bool INODETargetInfo::isValidTuneCPUName(StringRef Name) const {
//   bool Is64Bit = getTriple().isArch64Bit();
//   return llvm::INODE::parseTuneCPU(Name, Is64Bit);
// }

// void INODETargetInfo::fillValidTuneCPUList(
//     SmallVectorImpl<StringRef> &Values) const {
//   bool Is64Bit = getTriple().isArch64Bit();
//   llvm::INODE::fillValidTuneCPUArchList(Values, Is64Bit);
// }

// static void handleFullArchString(StringRef FullArchStr,
//                                  std::vector<std::string> &Features) {
//   Features.push_back("__INODE_TargetAttrNeedOverride");
//   auto RII = llvm::INODEISAInfo::parseArchString(
...
// ParsedTargetAttr INODETargetInfo::parseTargetAttr(StringRef Features) const {
...
//               llvm::INODEISAInfo::getTargetFeatureForExtension(ExtName);
...
//         StringRef MarchFromCPU = llvm::INODE::getMArchFromMcpu(Ret.CPU);
//         if (MarchFromCPU != "") {
//           Ret.Features.clear();
...
// INODETargetInfo::checkCallingConvention(CallingConv CC) const {
//   switch (CC) {
//   default:
//     return CCCR_Warning;
//   case CC_C:
//   case CC_INODEVectorCall:
//     return CCCR_OK;
//   }
// }
