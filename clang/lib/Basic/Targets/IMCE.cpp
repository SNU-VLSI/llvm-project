//===--- IMCE.cpp - Implement RISC-V target feature support --------------===//
//
...
// #include "llvm/TargetParser/IMCETargetParser.h"
#include <optional>

using namespace clang;
using namespace clang::targets;

ArrayRef<const char *> IMCETargetInfo::getGCCRegNames() const {
  // clang-format off
...
ArrayRef<TargetInfo::GCCRegAlias> IMCETargetInfo::getGCCRegAliases() const {
...
bool IMCETargetInfo::validateAsmConstraint(
...
// std::string IMCETargetInfo::convertConstraint(const char *&Constraint) const {
//   std::string R;
//   switch (*Constraint) {
//   case 'v':
...
void IMCETargetInfo::getTargetDefines(const LangOptions &Opts,
                                       MacroBuilder &Builder) const {
  // Builder.defineMacro("__riscv");
  // bool Is64Bit = getTriple().isIMCE64();
  ...
  //                       Twine(VScale->first * llvm::IMCE::RVVBitsPerBlock));
...
// #include "clang/Basic/BuiltinsIMCEVector.def"
#define BUILTIN(ID, TYPE, ATTRS)                                               \
  {#ID, TYPE, ATTRS, nullptr, HeaderDesc::NO_HEADER, ALL_LANGUAGES},
#define TARGET_BUILTIN(ID, TYPE, ATTRS, FEATURE)                               \
  {#ID, TYPE, ATTRS, FEATURE, HeaderDesc::NO_HEADER, ALL_LANGUAGES},
#include "clang/Basic/BuiltinsIMCE.def"
};

ArrayRef<Builtin::Info> IMCETargetInfo::getTargetBuiltins() const {
  return llvm::ArrayRef(BuiltinInfo,
                        clang::IMCE::LastTSBuiltin - Builtin::FirstTSBuiltin);
}

// bool IMCETargetInfo::initFeatureMap(
//     llvm::StringMap<bool> &Features, DiagnosticsEngine &Diags, StringRef CPU,
//     const std::vector<std::string> &FeaturesVec) const {

//   unsigned XLen = 32;

//   if (getTriple().isIMCE64()) {
//     Features["64bit"] = true;
//     XLen = 64;
//   } else {
//     Features["32bit"] = true;
...
//   const auto I = llvm::find(FeaturesVec, "__IMCE_TargetAttrNeedOverride");
...
//       return !llvm::IMCEISAInfo::isSupportedExtensionFeature(Ext);
//     };
...
//   auto ParseResult = llvm::IMCEISAInfo::parseFeatures(XLen, FeaturesVec);
//   if (!ParseResult) {
//     std::string Buffer;
...
// IMCETargetInfo::getVScaleRange(const LangOptions &LangOpts) const {
//   // IMCE::RVVBitsPerBlock is 64.
//   unsigned VScaleMin = ISAInfo->getMinVLen() / llvm::IMCE::RVVBitsPerBlock;
...
//   if (VScaleMin > 0) {
//     unsigned VScaleMax = ISAInfo->getMaxVLen() / llvm::IMCE::RVVBitsPerBlock;
...
// bool IMCETargetInfo::hasFeature(StringRef Feature) const {
//   bool Is64Bit = getTriple().isIMCE64();
...
// bool IMCETargetInfo::handleTargetFeatures(std::vector<std::string> &Features,
//                                            DiagnosticsEngine &Diags) {
//   unsigned XLen = getTriple().isArch64Bit() ? 64 : 32;
//   auto ParseResult = llvm::IMCEISAInfo::parseFeatures(XLen, Features);
//   if (!ParseResult) {
//     std::string Buffer;
//     llvm::raw_string_ostream OutputErrMsg(Buffer);
//     handleAllErrors(ParseResult.takeError(), [&](llvm::StringError &ErrMsg) {
...
// bool IMCETargetInfo::isValidCPUName(StringRef Name) const {
//   bool Is64Bit = getTriple().isArch64Bit();
//   return llvm::IMCE::parseCPU(Name, Is64Bit);
// }

// void IMCETargetInfo::fillValidCPUList(
//     SmallVectorImpl<StringRef> &Values) const {
//   bool Is64Bit = getTriple().isArch64Bit();
//   llvm::IMCE::fillValidCPUArchList(Values, Is64Bit);
// }

// bool IMCETargetInfo::isValidTuneCPUName(StringRef Name) const {
//   bool Is64Bit = getTriple().isArch64Bit();
//   return llvm::IMCE::parseTuneCPU(Name, Is64Bit);
// }

// void IMCETargetInfo::fillValidTuneCPUList(
//     SmallVectorImpl<StringRef> &Values) const {
//   bool Is64Bit = getTriple().isArch64Bit();
//   llvm::IMCE::fillValidTuneCPUArchList(Values, Is64Bit);
// }

// static void handleFullArchString(StringRef FullArchStr,
//                                  std::vector<std::string> &Features) {
//   Features.push_back("__IMCE_TargetAttrNeedOverride");
//   auto RII = llvm::IMCEISAInfo::parseArchString(
...
// ParsedTargetAttr IMCETargetInfo::parseTargetAttr(StringRef Features) const {
...
//               llvm::IMCEISAInfo::getTargetFeatureForExtension(ExtName);
...
//         StringRef MarchFromCPU = llvm::IMCE::getMArchFromMcpu(Ret.CPU);
//         if (MarchFromCPU != "") {
//           Ret.Features.clear();
...
// IMCETargetInfo::checkCallingConvention(CallingConv CC) const {
//   switch (CC) {
//   default:
//     return CCCR_Warning;
//   case CC_C:
//   case CC_IMCEVectorCall:
//     return CCCR_OK;
//   }
// }
