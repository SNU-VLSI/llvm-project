...
opt -passes='simplifycfg,instcombine' -S output/$filename_no_ext.ll -o output/${filename_no_ext}_opt.ll
# llc --march=IMCE -O1 output/$filename_no_ext.ll -o ./output/$filename_no_ext.s \
