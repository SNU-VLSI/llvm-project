...
public:
  ...
  void encodeInstruction(const MCInst &MI, raw_ostream &OS, SmallVectorImpl<MCFixup> &Fixups,
...
void IMCEMCCodeEmitter::encodeInstruction(const MCInst &MI, raw_ostream &OS,
